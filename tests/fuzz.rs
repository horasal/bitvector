...
fn fuzz_test() {
    ...
    for _ in 0 .. 5 {
        let v1 : Vec<usize> = rng.sample_iter(Uniform::new(1,10_000_000)).take(rng.gen_range(10,10_000)).collect();
        let v2 : Vec<usize> = rng.sample_iter(Uniform::new(1,10_000_000)).take(rng.gen_range(10,10_000)).collect();
